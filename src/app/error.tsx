...
export default function Error({
	...
	return (
		<div className="container-custom w-full h-screen flex flex-col items-center justify-center">
			<svg
			...
			<div className="flex flex-col items-center justify-center">
				<p className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-custom-text-primary mt-8">
					500
				</p>
				<p className="text-2xl md:text-3xl lg:text-4xl font-bold text-custom-text-primary mt-2">
					Server Error
				</p>
				<p className="md:text-lg xl:text-xl text-custom-text-secondary mt-4">
