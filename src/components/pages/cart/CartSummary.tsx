		...
		<div className="flex flex-col gap-8 mt-4 md:mt-0">
			<div className="cart-summary">
				...
				<div className="flex flex-col gap-3">
					...
					<p className="text-lg leading-6 tracking-wide font-normal" aria-label="cart-summary-items">
				...
				<div className="flex flex-col border-b border-custom-border-card py-6 gap-4">
					{cartItems.map(({product, quantity}) => (
						<div key={product.id} className="flex items-center justify-between">
							...
							<span className="text-custom-text-primary font-normal text-lg leading-6 tracking-wide whitespace-nowrap flex-shrink-0" aria-label="product-total-price">
				...
				<div className="flex items-center justify-between mb-4">
					<h4 className="text-custom-text-primary font-bold text-xl leading-6 tracking-wide flex-1 mr-3 truncate">
						Order Total
					</h4>
					<span className="text-custom-text-primary font-bold text-xl leading-6 tracking-wide whitespace-nowrap" aria-label="cart-total-price">
						$ {totalPrice}
					</span>
				</div>
			</div>
